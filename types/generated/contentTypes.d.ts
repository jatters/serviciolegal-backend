...
export interface ApiAbogadoAbogado extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoria_servicios: Schema.Attribute.Relation<
      'oneToMany',
    ...
    >;
    categorias_servicio_ls: Schema.Attribute.Relation<
      'oneToMany',
      'api::cat-service-ls.cat-service-ls'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    especialidad_ls: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    publishedAt: Schema.Attribute.DateTime;
    servicio: Schema.Attribute.Relation<'oneToMany', 'api::servicio.servicio'>;
    servicio_ls: Schema.Attribute.Relation<
      'oneToMany',
      'api::servicio-ls.servicio-ls'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiArticuloLsArticuloLs extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    servicios_ls: Schema.Attribute.Relation<
      'manyToOne',
      'api::servicio-ls.servicio-ls'
    >;
...
export interface ApiCatServiceLsCatServiceLs
  extends Struct.CollectionTypeSchema {
...
export interface ApiCategoriaServicioCategoriaServicio
  extends Struct.CollectionTypeSchema {
...
export interface ApiCategoriaCategoria extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    abogado: Schema.Attribute.Relation<'manyToOne', 'api::abogado.abogado'>;
    articulos_ls: Schema.Attribute.Relation<
      'manyToMany',
      'api::articulo-ls.articulo-ls'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    descriptionSEO: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    postsSl: Schema.Attribute.Relation<'oneToMany', 'api::articulo.articulo'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCompanyLsCompanyLs extends Struct.SingleTypeSchema {
  collectionName: 'companies_ls';
  info: {
    description: '';
    displayName: 'Compa\u00F1ia LS consulting';
    pluralName: 'companies-ls';
...
export interface ApiCondicionDeUsoCondicionDeUso
  extends Struct.SingleTypeSchema {
  collectionName: 'condiciones_de_usos';
  info: {
    description: '';
    displayName: 'Condiciones de uso';
    pluralName: 'condiciones-de-usos';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::condicion-de-uso.condicion-de-uso'
    >;
    publishedAt: Schema.Attribute.DateTime;
    SEO: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiContactoLsContactoLs extends Struct.SingleTypeSchema {
  collectionName: 'contactos_ls';
  info: {
    description: '';
    displayName: 'Contacto LS';
    pluralName: 'contactos-ls';
...
export interface ApiFaqLsFaqLs extends Struct.CollectionTypeSchema {
  collectionName: 'faqs_ls';
  info: {
    description: '';
    displayName: 'FAQ LS Consulting';
    pluralName: 'faqs-ls';
    singularName: 'faq-ls';
  };
  options: {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::faq-ls.faq-ls'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiInicioLsConsultingInicioLsConsulting
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::inicio-ls-consulting.inicio-ls-consulting'
    >;
...
export interface ApiNosotroLsNosotroLs extends Struct.SingleTypeSchema {
  collectionName: 'nosotros_ls';
  info: {
    description: '';
    displayName: 'Nosotros LS';
    pluralName: 'nosotros-ls';
...
export interface ApiPolicyLsPolicyLs extends Struct.SingleTypeSchema {
  collectionName: 'polices_ls';
  info: {
    description: '';
    displayName: 'Politica de privacidad LS';
    pluralName: 'polices-ls';
...
export interface ApiPoliticaDePrivacidadPoliticaDePrivacidad
  extends Struct.SingleTypeSchema {
  collectionName: 'politicas_de_privacidad';
  info: {
    description: '';
    displayName: 'Politica de privacidad';
    pluralName: 'politicas-de-privacidad';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::politica-de-privacidad.politica-de-privacidad'
    >;
    publishedAt: Schema.Attribute.DateTime;
    SEO: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiServicioLsServicioLs extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    informacionAdicional: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServicioServicio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::servicio.servicio'
    >;
    longDescriptionService: Schema.Attribute.Blocks &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTermLsTermLs extends Struct.SingleTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'T\u00E9rminos y condiciones LS';
    pluralName: 'terms-ls';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::abogado.abogado': ApiAbogadoAbogado;
      'api::articulo-ls.articulo-ls': ApiArticuloLsArticuloLs;
      'api::articulo.articulo': ApiArticuloArticulo;
      'api::cat-service-ls.cat-service-ls': ApiCatServiceLsCatServiceLs;
      'api::categoria-servicio.categoria-servicio': ApiCategoriaServicioCategoriaServicio;
      'api::categoria.categoria': ApiCategoriaCategoria;
      'api::company-ls.company-ls': ApiCompanyLsCompanyLs;
      'api::company.company': ApiCompanyCompany;
      'api::condicion-de-uso.condicion-de-uso': ApiCondicionDeUsoCondicionDeUso;
      'api::contacto-ls.contacto-ls': ApiContactoLsContactoLs;
      'api::contacto.contacto': ApiContactoContacto;
      'api::faq-ls.faq-ls': ApiFaqLsFaqLs;
      'api::faq.faq': ApiFaqFaq;
      'api::inicio-ls-consulting.inicio-ls-consulting': ApiInicioLsConsultingInicioLsConsulting;
      'api::inicio.inicio': ApiInicioInicio;
      'api::nosotro-ls.nosotro-ls': ApiNosotroLsNosotroLs;
      'api::nosotro.nosotro': ApiNosotroNosotro;
      'api::policy-ls.policy-ls': ApiPolicyLsPolicyLs;
